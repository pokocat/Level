    ...
    private void drawLeftCm(Canvas canvas, Paint paint){
        for (int i = 0; i < heightmm; i++){
            if (i%10 == 0) {
                ...
                canvas.drawLine((float)widthPx, (float)dpmm*i, (float)(widthPx-dpmm*8), (float)dpmm*i, paint);
                //draw a number every cm
                canvas.drawText(""+i/10, (float)(widthPx-dpmm*8-textSize), (float)(dpmm*i+textSize), paint);
            } else if (i%5 == 0) {
                //draw 5mm line every 5mm
                canvas.drawLine((float)widthPx, (float)dpmm*i, (float)(widthPx-dpmm*5), (float)dpmm*i, paint);
            } else {
                //draw 3mm line every mm
                canvas.drawLine((float)widthPx, (float)dpmm*i, (float)(widthPx-dpmm*3), (float)dpmm*i, paint);
            }
        }
    }
    ...
    private void drawRightIn(Canvas canvas, Paint paint){
        ...
        for (int i = 0; i < (heightFracInch); i++){
            if (i%32 == 0) {
                ...
                canvas.drawLine(0, (float)(heightPx- dpfi *(i)),
                        (float)(dpmm*8), (float)(heightPx-dpfi*(i)), paint);
                //draw a number every inch
                path.reset();
                path.moveTo((float)(dpmm*8+textSize/5), (float)(heightPx- dpfi *(i)-textSize*0.25));
                path.lineTo((float)(dpmm*8+textSize/5), (float)(heightPx- dpfi *(i)-textSize));
                canvas.drawTextOnPath(""+i/32, path, 0, 0, paint);
            } else if (i%16 == 0) {
                //draw 6mm line every 1/2 inch
                canvas.drawLine(0, (float)(heightPx- dpfi *(i)),
                        (float)(dpmm*6), (float)(heightPx- dpfi *(i)), paint);
            } else if (i%8 == 0) {
                //draw 4mm line every 1/4 inch
                canvas.drawLine(0, (float)(heightPx- dpfi *(i)),
                        (float)(dpmm*4), (float)(heightPx- dpfi *(i)), paint);
            } else if (i%4 == 0) {
                //draw 3mm line every 1/8 inch
                canvas.drawLine(0, (float)(heightPx- dpfi *(i)),
                        (float)(dpmm*3), (float)(heightPx- dpfi *(i)), paint);
            } else if (i%2 == 0) {
                //draw 2mm line every 1/16 inch
                canvas.drawLine(0, (float)(heightPx- dpfi *(i)),
                        (float)(dpmm*2), (float)(heightPx- dpfi *(i)), paint);
            } else {
                //draw 1.5mm line every 1/32 inch
                canvas.drawLine(0, (float)(heightPx- dpfi *(i)),
                        (float)(dpmm*1.5), (float)(heightPx- dpfi *(i)), paint);
            }
        }
    }
